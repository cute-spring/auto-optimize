...
- `plans/Generic_Skill_Vision_Gap_Plan_20260608.md`: post-checklist plan for the remaining strategic gaps to the long-term generic skill vision.
- `release_readiness_gate/README.md`: governance, release gate, and status-audit support artifacts.
- `assessments/`: point-in-time architectural and execution decisions, including defer/accept evaluations.
